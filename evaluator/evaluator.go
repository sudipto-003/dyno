...
func Eval(node ast.Node, env *object.Environment) object.Object {
	...
	case *ast.ReturnStatement:
		val := Eval(node.ReturnedValue, env)
		if isError(val) {
			return val
		}
...
func evalBlockStatements(block *ast.BlockStatements, env *object.Environment) object.Object {
	var result object.Object
...
func evalStringInfixOperation(op string, left, right object.Object) object.Object {
...
func unwrapReturnedValue(obj object.Object) object.Object {
...
func evalIndexExpression(left, index object.Object) object.Object {
	...
	default:
		return newError("index operator not supported: %T", left.Type())
	}
}
